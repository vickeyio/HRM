    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">{{ isEditMode ? 'Edit Designation' : 'Add Designation' }}</h4>
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">{{ isEditMode ? 'Save Changes' : 'Add Designation' }}</button>
          </div>
        </form>
      </div>
    </div>
