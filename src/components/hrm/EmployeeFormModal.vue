      ...
      <div class="tab-content">
        ...
        <div v-show="activeTab === 'permissions'" class="tab-pane fade show active">
          <div class="card bg-light shadow-none mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-3">
            ...
            <table class="table align-middle mb-0">
              ...
              <tbody>
                <tr v-for="module in modules" :key="module">
                  ...
                  <td><input class="form-check-input" type="checkbox" :checked="enableAllModules || selectAllPermissions" /></td>
                  <td><input class="form-check-input" type="checkbox" :checked="enableAllModules || selectAllPermissions" /></td>
                  <td><input class="form-check-input" type="checkbox" :checked="enableAllModules || selectAllPermissions" /></td>
                  <td><input class="form-check-input" type="checkbox" :checked="enableAllModules || selectAllPermissions" /></td>
                </tr>
