...
const activeMenu = computed(() => {
  ...
  if (['/settings', '/billing'].includes(currentRoute.value)) return 'administration';
  return '';
});
...
watch(currentRoute, (newPath) => {
  ...
  if (['/employees', '/departments', '/designations'].includes(newPath)) openMenus.value.employees = true;
  ...
  if (['/settings', '/billing'].includes(newPath)) openMenus.value.administration = true;
}, { immediate: true });
